...
mutation InsertFobGame($points: numeric!, $email: String!) {
  insert_fob_game(objects: {points: $points, email: $email, game_type: "taraaling"}) {
    returning {
      id
    }
  }
    ...
    <div className="modal modal-sm active">
      ...
      <div className="modal-container">
        <div className="modal-header">
          <div className="modal-title h4">Taraaling</div>
        </div>
        <div className="modal-body">
          <div className="content h6">
            ...
            {gameState === GAME_STATE.READY
              ...
              : `Tú fekk: ${totalScore} stig, har ið tíðsbonusið taldi ${totalScore > 0 ? timeBonus : 0} stig. Tú fekst ${score} fyri at seta myndirnar í tilhoyrandi kassa.`}
          </div>
        </div>
